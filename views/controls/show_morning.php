...
<div id="title">
   ...
   <h4><?php echo "Utilisateur: $user->firstname $user->lastname"?></h4>
     ...
     <?php foreach($tasks as $task): ?> 
      ...
      <?php endforeach ?>
      <br /><br />
    <a href="/controle_serveur/index.php/controls/edit?id=<?php echo $control->id."&type=".$control->type; ?>" id="link">Modifier </a> 
    <br />
    <a href="/controle_serveur/index.php/controls/delete?id=<?php echo $control->id ?>" id="link" rel="nofollow" data-method="delete" data-confirm="Êtes vous sûr?">Supprimer</a> 
    <br />
    <a href="/controle_serveur/index.php/controls/list" id="link">Retour</a>
    <br />
